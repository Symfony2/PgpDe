...
namespace OpenPGPzzz
{
    ...
    public class PgpDecrypt
    {
        ...
        public string Decrypt(Stream input, string outputpath)
        {
            input = PgpUtilities.GetDecoderStream(input);
            //try
            //{
                ...
                PgpPrivateKey privKey = m_encryptionKeys.PrivateKey;
                PgpPublicKeyEncryptedData pbe = null;
                foreach (PgpPublicKeyEncryptedData pked in enc.GetEncryptedDataObjects())
                {
                    if (privKey != null)
                ...
                if (message is PgpCompressedData)
                {
                    ...
                    PgpObjectFactory o = new PgpObjectFactory(((PgpCompressedData)message).GetDataStream());
                    ...
                    if (message is PgpOnePassSignatureList)
                    {
                       ...
                       /* string outFileName = p2.FileName;
                        ...
                        PgpSignatureList p3 = (PgpSignatureList)o.NextPgpObject();
                        PgpSignature firstSig = p3[0];
                        if (ops.Verify(firstSig))
 	                    {
